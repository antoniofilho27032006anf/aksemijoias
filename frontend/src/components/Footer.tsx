      ...
      <div className="mx-auto max-w-2xl px-4 py-5 sm:px-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2">
            <img src="/logo.png" alt="AK Semijóias" className="h-8 w-auto object-contain" />
          </Link>
        ...
        <div className="mt-4 flex flex-wrap gap-x-5 gap-y-1.5">
          {[
            ...
            <Link
              key={link.href}
              href={link.href}
              className="text-[12px] text-gray-500 transition hover:text-[#7C3D8E]"
            >
              {link.label}
            </Link>
          ))}
        ...
        <div className="mt-4 border-t pt-3" style={{ borderColor: '#e8d5f5' }}>
